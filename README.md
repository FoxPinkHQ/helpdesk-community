...
**Version:** [next] -- **License:** LGPL-3 -- **Publisher:** FoxPink -- Maintained for **Odoo 16.0-19.0** (one validated build per series)
...
| Odoo Version | Status |
|---|---|
| 16.0 | (check) This branch |
| 15.0 | [Branch 15.0](https://github.com/FoxPinkHQ/helpdesk-community/tree/15.0) |
| 16.0 | ✅ This branch |
