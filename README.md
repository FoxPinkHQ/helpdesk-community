...
- **This build:** Odoo 15.0 (Community / Enterprise)
...
See [docs/CHANGELOG.md](docs/CHANGELOG.md). Latest: **15.0.1.0.4** — fixed Bugs A–E (category color save, portal CSRF, stage default, assign, filter labels) and mail-template rendering.
