...
```bash
git clone -b 14.0 https://github.com/FoxPinkHQ/helpdesk-community addons/helpdesk_community
```
...
- **This build:** Odoo 14.0 (Community / Enterprise)
...
See [docs/CHANGELOG.md](docs/CHANGELOG.md). Latest: **14.0.1.0.4** — fixed Bugs A–E (category color save, portal CSRF, stage default, assign, filter labels) and mail-template rendering.
